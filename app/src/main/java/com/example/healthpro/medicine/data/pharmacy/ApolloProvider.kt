...
/**
 * Apollo Pharmacy provider using deep linking.
 * Package: in.apollo.android (correct Play Store package)
 */
class ApolloProvider(private val context: Context) : PharmacyProvider {

    companion object {
        const val PACKAGE_NAME = "in.apollo.android"
        private const val SEARCH_URL = "https://www.apollopharmacy.in/search?q="
    ...
    override suspend fun orderMedicine(orderRequest: OrderRequest): OrderResponse =
        withContext(Dispatchers.Main) {
            ...
            OrderResponse(
                success = true,
                message = "Opening Apollo Pharmacy to search: $query",
    ...
    override fun getDisplayName(): String = "Apollo Pharmacy"
